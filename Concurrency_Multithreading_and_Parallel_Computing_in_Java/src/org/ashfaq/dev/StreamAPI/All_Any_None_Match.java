...
public class All_Any_None_Match {
	public static void main(String[] args) {
		...
		bookList.stream().allMatch(x -> x.getAuthor().equals("F. Scott Fitzgerald"));
		bookList.stream().anyMatch(x -> x.getAuthor().equals("F. Scott Fitzgerald"));
		bookList.stream().noneMatch(x -> x.getAuthor().equals("F. Scott Fitzgerald"));
	}
}
